...
void loop() {
  ...
  int moisturePercentage = map(moistureValue, 0, 4095, 0, 0);
  ...
  // Control the 12V buck converter based on a condition (e.g., moisture level, temperature, or any other criteria)
